...
impl HttpRequest {
    ...
    pub async fn version_data(client: Client, package_name: &String, version: &String) -> Result<VersionData, CommandError> {
    ...
    pub async fn package_data(client: Client, package_name: &String) -> Result<PackageData, CommandError> {
